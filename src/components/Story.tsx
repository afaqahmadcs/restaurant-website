...
export default function Story() {
  return (
    <div id="story">
      ...
      <section className="section-padding px-margin-mobile md:px-margin-desktop bg-surface-container-low">
        <div className="max-w-container-max mx-auto">
          <div className="grid-12 items-center gap-16">
            ...
            <div className="md:col-span-6 md:col-start-7 relative h-[450px] md:h-[550px] w-full">
              <div className="absolute inset-0 border border-surface-variant -translate-x-4 translate-y-4 -z-10" />
      ...
      <section className="relative w-full min-h-[75vh] flex items-center bg-surface-container-lowest">
